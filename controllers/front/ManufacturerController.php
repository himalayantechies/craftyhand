...
class ManufacturerControllerCore extends FrontController
{
	...
	protected function assignOne()
	{
		...
		$this->context->smarty->assign(array(
			...
			//'HOOK_EXTRA_RIGHT' => Hook::exec('displayRightColumnManufacturer'),
			//'HOOK_MANUFACTURER_OOS' => Hook::exec('actionManufacturerOutOfStock', array('manufacturer' => $this->manufacturer)),
			//'HOOK_MANUFACTURER_ACTIONS' => Hook::exec('displayManufacturerButtons', array('manufacturer' => $this->manufacturer)),
			//'HOOK_MANUFACTURER_TAB' =>  Hook::exec('displayManufacturerTab', array('manufacturer' => $this->manufacturer)),
			'HOOK_MANU_TAB_CONTENT' =>  Hook::exec('displayManufacturerTabContent', array('manufacturer' => $this->manufacturer)),
		));
	}
