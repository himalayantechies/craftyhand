...
class AuthControllerCore extends FrontController
{
	...
	public function initContent()
	{
		...
		$this->displayMySummary(); // added by ram for test purpose.
	...
	protected function processSubmitAccount()
	{
		...
		//Added by Ram: testing additional confirm email address for Guest Checkout only.
		$error_email = false;
		...
		//Added by Ram for confirm Email Address
		if ($error_email)
			$this->errors[] = Tools::displayError('Email and Confirm Email address do not match.');		
	...
	/*
	Added by Ram to display cart content in carrier page
	*/
