...
//   TOGGLE FOOTER
// footer-icons-define
		var footer_icon_plus = 'icon-double-angle-right';
		var footer_icon_minus = 'icon-double-angle-down';
...
// products-icons-define
		var product_icon_plus = 'icon-double-angle-right-alt';
		var product_icon_minus = 'icon-double-angle-down-alt';
...
// columns-icons-define
		var columns_icon_plus = 'icon-double-angle-right';
		var columns_icon_minus = 'icon-double-angle-down';
