...
{/if}
{if !$opc}
	<h1 style="font-size:24px; font-weight:normal;margin:23px 0 -12px;"><span>{l s='Choose a carrier'}</span></h1> 
{else}
...
<p class="cart_navigation clearfix submit" style="margin:-33px 0 0;">
		<input type="hidden" name="step" value="3" />
		<input type="hidden" name="back" value="{$back}" />
		
		{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
			<input type="submit" name="processCarrier" value="{l s='Proceed to Payment'} &raquo;" class="btn-success btn" style="float:right;font-size:13px;" />
		{/if}
	</p>
...
{else}
	<!--<h2 class="carrier_title"><span>{l s='Choose Courier that suits you best your delivery method'}</span></h2>-->
	<!--<h2 class="carrier_title"><span>{l s='Choose Courier service that suits you best for delivery'}</span></h2>-->
	...
	{if isset($delivery_option_list)}
		{foreach $delivery_option_list as $id_address => $option_list}
			...
			<div class="delivery_options" style="padding-top:0px;">
			
			{foreach $option_list as $key => $option}
				<div class="delivery_option {if ($option@index % 2)}alternate_{/if}item">
					<label for="delivery_option_{$id_address}_{$option@index}" style="margin-bottom:0px;">
						<table class="resume" style="margin-bottom:0px;">
							<tr>
                            <td style="width:10%;text-align:center;">
								...
								<td class="delivery_option_logo" style="width:25%;">
								...
								<td style="width:40%; padding:0 0 0 150px;">
								...
								<td >
								<div class="delivery_option_price" style="float:right;">
...
<div>
	<h2 class="condition_title titled_box" style="margin:10px 0 0;"><span>{l s='Terms of service'}</span></h2>
	</div>
    <p class="checkbox" style="padding:2px 0 0;">
