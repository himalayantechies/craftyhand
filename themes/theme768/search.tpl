...
{include file="$tpl_dir./breadcrumb-withleftmenu.tpl"}
<h1 style="font-size:24px; font-weight:normal;font-family:arial;padding-bottom:8px;" {if isset($instant_search) && $instant_search}id="instant_search_results"{/if}><span>
...
{else}
<div class="titled_box">	<h2 class="nbresult"><span class="big" style="margin:-34px 0 0; float:right;">{if $nbProducts == 1}{l s='%d result has been found.' sprintf=$nbProducts|intval}{else}{l s='%d results have been found.' sprintf=$nbProducts|intval}{/if}</span></h2></div>
