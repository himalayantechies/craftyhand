...
{include file="$tpl_dir./breadcrumb.tpl"}
	<aside id="left_column" class="span3 column">
		...
		<div>
		<b>Our Contact in the US</b><br/>
		Himalayan Craftyhand <br/>
		826 w golf road<br/>
		Niles IL 60714<br/>
		USA<br/><br/>
		
		Phone:+1 312 608 4513		
		...
		<hr>		
		<div>
		<b>Our Contact in Nepal</b><br/>
		Mikhabahal, Patan Dhoka <br/>
		P.O.Box: 285(Patan)<br/>
		Lalitpur, Nepal<br/><br/>
		
		Email info@craftyhand.com<br/>
		Phone: 9803156056
	...
	<!--<iframe width="270" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=27.677894,85.321325&amp;aq=&amp;sll=37.0625,-95.677068&amp;sspn=44.339735,79.013672&amp;ie=UTF8&amp;ll=27.677894,85.321325&amp;spn=0.00152,0.002411&amp;t=m&amp;z=14&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=27.677894,85.321325&amp;aq=&amp;sll=37.0625,-95.677068&amp;sspn=44.339735,79.013672&amp;ie=UTF8&amp;ll=27.677894,85.321325&amp;spn=0.00152,0.002411&amp;t=m&amp;z=14" style="color:#0000FF;text-align:left" target="_blank">View Larger Map</a></small>-->
		</div>
	</aside>
<h1><span>{l s='For all kind of enquiries'} - {if isset($customerThread) && $customerThread}{l s='Your reply'}{else}{l s='Contact us'}{/if}</span></h1>
...
{else}
	<p class="title-pagecontact"><i class="icon-comment-alt"></i>{l s='For questions about an order, wholesale and for more information about our products'}.</p>
	...
	<form id="contact_form" action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std" enctype="multipart/form-data">
		<fieldset class="titled_box">
			...
			{else}
				<select id="ide_contact" name="id_contact" onchange="showElemFromSelect('id_contact', 'desc_contact')">
					<option value="0">{l s='-- Choose --'}</option>
				{foreach from=$contacts item=contact}
					<option value="{$contact.id_contact|intval}" {if isset($smarty.post.id_contact) && $smarty.post.id_contact == $contact.id_contact}selected="selected"{else}{if !isset($smarty.post.id_contact) && $contact.id_contact == 8}selected="selected"{/if}{/if}>{$contact.name|escape:'htmlall':'UTF-8'}</option>
				{/foreach}
				</select>
			</p>
