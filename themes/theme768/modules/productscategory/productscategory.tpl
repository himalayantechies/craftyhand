...
{if count($categoryProducts) > 0 && $categoryProducts !== false}
	<section class="page_product_box blockproductscategory">
		<h3> <span style="font-size:14px;font-weight:bold;"><!--{$categoryProducts|@count}--> {l s='You may also like other products from ' mod='productscategory'} {$category_name} category </span><i class="icon-toggle icon-minus-sign-alt"></i></h3>
