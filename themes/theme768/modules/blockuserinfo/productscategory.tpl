...
{if count($categoryProducts) > 0 && $categoryProducts !== false}
	<section class="page_product_box blockproductscategory">
		<h3> <span style="font-size:18px;font-weight:normal;">{$categoryProducts|@count} {l s='other products in ' mod='productscategory'} {$category_name}</span><i class="icon-toggle icon-minus-sign-alt"></i></h3>
    	<div id="block-category-slider" class="carusel-inner responsive  toggle_content">
        	<ul id="carouselproduct" class="carousel-ul">
			<ul id="carouselproduct" >
