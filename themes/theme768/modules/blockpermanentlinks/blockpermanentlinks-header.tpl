...
<!--
    <ul id="header_links">
        ...
        <li id="header_link_sitemap"><a class="header_links_sitemap" href="{$link->getPageLink('sitemap')}" title="{l s='sitemap' mod='blockpermanentlinks'}">{l s='sitemap' mod='blockpermanentlinks'}</a></li>
