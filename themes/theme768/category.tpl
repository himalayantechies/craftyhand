...
{if isset($category)}
	{if $category->id AND $category->active}
		...
		{else}
			...
			<!--
			Hide Catgegory Image Commented by Manish Oct 28 2013
		...
		{/if}
				...
				<!--
				Hide Catgegory Description Commented by Manish Oct 28 2013
		...
		<!-- Subcategories -->
		<!--
		commented out by manish to hide sub category list Oct 28 2013
